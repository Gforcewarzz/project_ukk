...
if (isset($_POST['submit'])) {
    $pelanggan_id = $_SESSION['pelanggan_id']; // Get the pelanggan_id from the session
    $tanggal = date('Y-m-d');
    $total_harga = 0;
...
<body>
    ...
    <form method="POST">
        <div class="form-group">
            ...
            <input type="text" id="pelanggan" value="<?= $_SESSION['nama_pelanggan']; ?>" disabled>
            <input type="hidden" name="pelanggan_id" value="<?= $_SESSION['pelanggan_id']; ?>">
        </div>
